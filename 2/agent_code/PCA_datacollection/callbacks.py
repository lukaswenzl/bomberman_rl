...
def setup(self):
    ...
    self.datacollection = []
    self.datacollection_full_field = []
    self.ngames =0
...
def act(self):
    ...
    #safe game state
    self.datacollection.append( create_input_arena(self, in_size=9))
    self.datacollection_full_field.append( create_input_arena(self, in_size=33))
...
def end_of_episode(self):
    ...
    if self.ngames ==49:
        a = np.asarray(self.datacollection)
        np.savetxt("datacollection.csv", a, delimiter=",")


        a = np.asarray(self.datacollection_full_field)
        np.savetxt("datacollection_full_field.csv", a, delimiter=",")
